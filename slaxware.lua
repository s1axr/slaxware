--[[
  ...
  ______   __         ______   __    __  __       __   ______   _______   ________ 
 /      \ /  |       /      \ /  |  /  |/  |  _  /  | /      \ /       \ /        |
/$$$$$$  |$$ |      /$$$$$$  |$$ |  $$ |$$ | / \ $$ |/$$$$$$  |$$$$$$$  |$$$$$$$$/ 
$$ \__$$/ $$ |      $$ |__$$ |$$  \/$$/ $$ |/$  \$$ |$$ |__$$ |$$ |__$$ |$$ |__    
$$      \ $$ |      $$    $$ | $$  $$<  $$ /$$$  $$ |$$    $$ |$$    $$< $$    |   
...
-- Features: auto-reset at 10hp, aimlock, esp
-- The Streets
...
ESPToggle.Position = UDim2.new(0.05, 0, 0, 245)
...
TargetInput.Position = UDim2.new(0.05, 0, 0, 465)
TargetInput.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
TargetInput.BorderSizePixel = 0
TargetInput.Text = ""
TargetInput.PlaceholderText = "type name / display name.."
TargetInput.PlaceholderColor3 = Color3.fromRGB(130, 130, 130)
...
TargetInput.FocusLost:Connect(function()
    local input = TargetInput.Text:lower()
    CAMLOCK_TARGET = nil
    for _, plr in pairs(Players:GetPlayers()) do
        if plr ~= LocalPlayer and (plr.Name:lower():find(input) or plr.DisplayName:lower():find(input)) then
            CAMLOCK_TARGET = plr
            TargetLabel.Text = "Target: " .. plr.Name
            break
        end
    end
    if not CAMLOCK_TARGET then
        TargetLabel.Text = "Target: none"
    end
end)
...
local NameAimlockBox = Instance.new("TextBox")
NameAimlockBox.Size = UDim2.new(0.9, 0, 0, 32)
NameAimlockBox.Position = UDim2.new(0.05, 0, 0, 688)
NameAimlockBox.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
NameAimlockBox.BorderSizePixel = 0
NameAimlockBox.Text = ""
NameAimlockBox.PlaceholderText = "type player name to aimlock.."
NameAimlockBox.PlaceholderColor3 = Color3.fromRGB(120, 120, 120)
NameAimlockBox.TextColor3 = Color3.fromRGB(255, 200, 50)
NameAimlockBox.TextSize = 13
NameAimlockBox.Font = Enum.Font.GothamSemibold
NameAimlockBox.ClearTextOnFocus = false
NameAimlockBox.Parent = Frame
...
-- Resolve name when user finishes typing
NameAimlockBox.FocusLost:Connect(function()
    local input = NameAimlockBox.Text:lower():match("^%s*(.-)%s*$") -- trim
    NAME_AIMLOCK_TARGET = nil
    ...
    if NAME_AIMLOCK_TARGET then
        ...
        NameAimlockLabel.Text = "Name Aimlock: " .. NAME_AIMLOCK_TARGET.Name
        ...
        if input ~= "" then
            NameAimlockLabel.Text = "Name Aimlock: not found"
            NameAimlockStatus.Text = "Status: player not found"
            NameAimlockStatus.TextColor3 = Color3.fromRGB(200, 80, 0)
        else
            NameAimlockLabel.Text = "Name Aimlock: none"
            NameAimlockStatus.Text = "Status: inactive"
            NameAimlockStatus.TextColor3 = Color3.fromRGB(170, 0, 0)
